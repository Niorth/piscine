...
<div class="section">
  ...
  <div class="container">
    ...
    <div class="row">
      <form action="<?php echo site_url("Product/$action") ?>" method="post" id="checkout-form" class="form-inline" >

          <input name="key" type="hidden" <?php if (isset($key)) echo "value = \"" .  $key . "\""?>>
          <input name="idBoutique" type="hidden" <?php if (isset($)) echo "value = \"" .  $key . "\""?>>
